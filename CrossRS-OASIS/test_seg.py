...
parser.add_argument('--label_percent', type=int, default=40, help='10, 40 and 100')
...
if __name__ == '__main__':
    ...
    csv_writter('DeepAtlas seg_net test', snapshot_path +  model_name)
    line = 'idx'
    for i in range(36):
        line = line + ',' + dict[i]
    ...
    with torch.no_grad():
        ...
        for img, true_seg in test_generator:
            ...
            dsc_seg = dice_val(predict_seg, true_seg.long(), 36)
            dsc_seg_substruct = dice_val(predict_seg, true_seg.long(), 36, False)
            ...
            line = dice_val_substruct(predict_seg, true_seg.long(), 36, stdy_idx)
