...
parser.add_argument('--exp', type=str,
                    default='SYMNet_lc', help='model_name SYMNet ')
parser.add_argument('--batch_size', type=int, default=1, help='batch size per gpu')
parser.add_argument('--start_channel', type=int, default=8, help="number of start channels")
parser.add_argument('--label_percent', type=int, default=100, help='25 or 100')
...
snapshot_path = "/home/gdut-627/huang/RRS-LPBA/model/" + args.exp + \
    "_{}labels/".format(args.label_percent)
...
# model_name = "reg_net_pretrained_60000"
...
if __name__ == '__main__':
    ...
    fixed_names = test_path[:2]
    moving_names = test_path[2:]
