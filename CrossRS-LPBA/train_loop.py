...
parser.add_argument('--start_channel', type=int, default=8, help="number of start channels")
...
# reg loss
parser.add_argument('--local_ori', type=float, default=10.0,
...
seg_net_pretrained = "/home/gdut-627/huang/RRS-LPBA/model/mono-seg_25labels/mono_seg_net_best.pth"
reg_net_pretrained = "/home/gdut-627/huang/RRS-LPBA/model/SYMNet_10.0ori_0.01mag/reg_net_pretrained_60000.pth"
...
if __name__ == "__main__":
    ...
    # Load data
    train_path = read_data_csv(train_data_path + "train_25per.csv")
